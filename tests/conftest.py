...
def test_user(client):
    user_data = {"email": "marco123@gmail.com", "password": "passmarco123"}
...
def test_user2(client):
    user_data = {"email": "marco@gmail.com", "password": "passmarco123"}
    res = client.post("/users/", json=user_data)
    assert res.status_code == 201 
    print(res.json())
    new_user = res.json()
...
def test_posts(test_user, session, test_user2):
    ...
    posts = list(post_map) # convert the map to a list 
